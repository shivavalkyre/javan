 $(function(){
            $('#dg').edatagrid({
                url: '../control/get_setting_ss.php',
                saveUrl: '../control/save_setting_ss.php',
                updateUrl: '../control/update_setting_ss.php',
                destroyUrl: '../control/delete_setting_ss.php'
            });
			...
			//alert(kd_supplier);
				...
				opts.url = '../control/get_anggota.php';
