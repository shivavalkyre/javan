 $(function(){
            $('#dg').edatagrid({
                url: '../control/get_simpanan_pokok.php',
                saveUrl: '../control/save_simpanan_pokok.php',
                updateUrl: '../control/update_simpanan_pokok.php',
                destroyUrl: '../control/delete_simpanan_pokok.php'
            });
