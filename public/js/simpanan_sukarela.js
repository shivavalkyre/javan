 $(function(){
            $('#dg').edatagrid({
                url: '../control/get_simpanan_sukarela.php',
                saveUrl: '../control/save_simpanan_sukarela.php',
                updateUrl: '../control/update_simpanan_sukarela.php',
                destroyUrl: '../control/delete_simpanan_sukarela.php'
            });
