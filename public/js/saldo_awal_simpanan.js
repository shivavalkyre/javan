 $(function(){
            $('#dg').edatagrid({
                url: '../control/get_saldo_awal_simpanan.php',
                saveUrl: '../control/save_saldo_awal_simpanan.php',
                updateUrl: '../control/update_saldo_awal_simpanan.php',
                destroyUrl: '../control/delete_saldo_awal_simpanan.php'
            });
